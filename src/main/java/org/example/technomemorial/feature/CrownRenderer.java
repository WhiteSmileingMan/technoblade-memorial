package org.example.technomemorial.feature;
...
public class CrownRenderer<S extends LivingEntityRenderState, M extends EntityModel<? super S>> extends FeatureRenderer<S, M> {

    private final Identifier TEXTURE = Identifier.ofVanilla("textures/entity/pig/crown.png");
    private final M model;
    private final M babyModel;

    public CrownRenderer(FeatureRendererContext<S, M> context, M model, M babyModel) {
        super(context);
        this.model = model;
